...
Felhőszolgáltatásnak az AWS App Runner-t választottam. Ez lehetővé teszi többek között Node.js alapú alkalmazások futtatását minimális konfigurációval. A publikus GitHub repoval összekötve minden `git push` esetén automatikusan frissíti az alkalmazás kódját és leállítja a régi kóddal indított alkalmazáspéldányokat. Adatbázisként szintén AWS által kezelt S3 Bucket-t és natív Postgres-t használok. Az alkalmazás működéséhez szükség volt a megfelelő jogosultságok konfigurálására AWS IAM-ben. Az adatbázissémát a Drizzle ORM keretrendszerrel konfigurálom be, mellyel adatmigrációs SQL szkripteket lehet generálni.